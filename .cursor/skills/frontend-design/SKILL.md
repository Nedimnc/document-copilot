...
description: Guidance for distinctive, intentional visual design when building new UI or reshaping an existing one. Helps with aesthetic direction, typography, and making choices that don't read as templated defaults. Use when designing, redesigning, or restyling frontend UI, choosing palettes/typography/layout, or building a design system.
---
...
Adapted from Anthropic's `frontend-design` skill: https://github.com/anthropics/skills/blob/main/skills/frontend-design/SKILL.md
